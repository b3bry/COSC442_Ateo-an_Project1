...
public class GameMaster {
	...
	/** The game master dice. */
	private GameMasterDice gameMasterDice = new GameMasterDice();
	...
	public GameMaster() {
		...
		gameMasterDice.setDice(new Die[] { new Die(), new Die() });
	}
    ...
    public void btnRollDiceClicked() {
		int[] rolls = gameMasterDice.rollDice(this.gui);
	 ...
	 */
	public int[] rollDice() {
		return gameMasterDice.rollDice(this.gui);
	}
